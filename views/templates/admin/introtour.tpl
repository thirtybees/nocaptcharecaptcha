			...
			steps: [
				{
					...
					content: "{/literal}{l s='Here\'s a short tour to get you started quickly with the module.' mod='nocaptcharecaptcha'}{literal}",
					target: "main-panel",
					placement: "bottom"
				},
				{
				...
				{
					title: "{/literal}{l s='Documentation' mod='nocaptcharecaptcha'}{literal}",
					content: "{/literal}{l s='To get the most out of the module, make sure you read the documentation.' mod='nocaptcharecaptcha'}{literal}",
					target: "doc-panel",
					placement: "bottom"
				},
				{
					title: "{/literal}{l s='Site and secret keys' mod='nocaptcharecaptcha'}{literal}",
					content: "{/literal}{l s='reCAPTCHA requires your site and secret keys.' mod='nocaptcharecaptcha'}{literal}",
